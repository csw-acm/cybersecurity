...
Let's get started with our first Python program. First, open Geany. You will find it in the Main Menu, then Programming and Geany will be right there. It’s a programmer’s text editor. You can use a normal text editor also but the syntax highlighting is a useful feature to have; it can make reading code much easier on the eyes.

Once you have Geany open, make a new file, call it 'helloworld.py' and save it somewhere.
...
So create a new file in Geany and call it whatever you like. Make sure it ends in .py!
...
Now create a new Python file in Geany and type this:
...
Let's show you an example. Create a new Python script in Geany and type:
...
Now let's talk about conditionals. What if you only want some code to run if a certain thing is true? Let's explore how we can do that. Create a new Python script in Geany and type:
...
Well, we can use loops for that. Python makes this much easier than other programming languages. You know the drill by now: create a new Python script in Geany and start typing:
